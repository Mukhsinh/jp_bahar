...
AND NOT EXISTS (SELECT 1 FROM t_pool_revenue WHERE description = 'Pendapatan Operasional');

INSERT INTO t_pool_revenue (pool_id, description, amount) 
SELECT id, 'Pendapatan Non-Operasional', 100000000.00 FROM t_pool WHERE period = '2024-03'
AND NOT EXISTS (SELECT 1 FROM t_pool_revenue WHERE description = 'Pendapatan Non-Operasional');
...
AND NOT EXISTS (SELECT 1 FROM t_pool_deduction WHERE description = 'Biaya Operasional');

INSERT INTO t_pool_deduction (pool_id, description, amount) 
SELECT id, 'Cadangan Dana', 20000000.00 FROM t_pool WHERE period = '2024-03'
AND NOT EXISTS (SELECT 1 FROM t_pool_deduction WHERE description = 'Cadangan Dana');
...
BEGIN
  ...
  IF emp_id IS NOT NULL THEN
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 95.00;
    END IF;
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 90.00;
    END IF;
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 100.00;
    END IF;
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 99.80;
    END IF;
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 20.00;
    END IF;
    ...
    IF ind_id IS NOT NULL THEN
      ...
      ON CONFLICT (employee_id, indicator_id, period) DO UPDATE SET realization_value = 85.00;
    END IF;
